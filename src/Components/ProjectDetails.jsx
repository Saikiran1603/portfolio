...
export default function ProjectDetails() {
    ...
    return (
        <div>
            <button className='bg-[#D5FF3F]  p-1 rounded-lg ml-5  md:ml-25 lg:ml-25 mt-5 mb-5 cursor-pointer' onClick={() => back("/projects")} >Back</button>
            <div className='md:flex lg:flex justify-around'>
                <div className='w-fullsm:w-96 md:w-96 lg:w-96 rounded-lg'>
                ...
                <div>
                    ...
                    <p className='text-[#D5FF3F]'>Tech Stack</p>
                    ...
                    <div className='flex gap-3'>
                        <button className='bg-[#D5FF3F] w-32 flex justify-center items-center p-1 rounded-lg'><FaLaptop />Demo</button>
                        <button className='bg-[#D5FF3F] w-32 flex justify-center items-center p-1 rounded-lg'><FaGithub className='' />GitHub</button>
                    </div>
                </div>
            </div>
            <div className='p-3 bg-gray-800 mt-5 mb-5 rounded-lg border-white shadow-lg'>
                <h1 className='text-[#D5FF3F]  text-3xl'>Main Features</h1>
                <ol >
